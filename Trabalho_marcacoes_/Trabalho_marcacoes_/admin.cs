    ...
    public partial class admin : Form
    {
        ...
        public admin()
        {
            ...
            while (Reader.Read())
            {
                ...
                string[] bomdia = new string[] { Reader["id"].ToString(), Reader["nome"].ToString(), Reader["password"].ToString(), Reader["codigo_postal_cliente"].ToString() };
                cliente_mos.Items.Add(new ListViewItem(bomdia));
            }
            ...
            while (Reader.Read())
            {
                ...
                string[] bomdia = new string[] { Reader["id"].ToString(), Reader["nome"].ToString(), Reader["password"].ToString(), Reader["codigo_postal_trabalhador"].ToString(), Reader["especialidade_tabela_trabalhador"].ToString() };
                trabalhador_mos.Items.Add(new ListViewItem(bomdia));
            }
            ...
            while (Reader.Read())
            {
                ...
                string[] bomdia = new string[] { Reader["id"].ToString(), Reader["nome_cliente_id"].ToString(), Reader["nome_trabalhador_id"].ToString(), Reader["especialidade_marcacao"].ToString(), ((DateTime)Reader["dia_marcacao"]).ToShortDateString(), Reader["hora"].ToString() };
                marcacoes_mos.Items.Add(new ListViewItem(bomdia));
            }
